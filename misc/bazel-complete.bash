...
BAZEL_COMMAND_LIST="analyze-profile aquery build canonicalize-flags clean config coverage cquery dump fetch focus help info license mobile-install mod print_action query run shutdown sync test version"
BAZEL_INFO_KEYS="
workspace
install_base
output_base
...
--experimental_enable_scl_dialect
--noexperimental_enable_scl_dialect
--experimental_execution_log_compact_file=path
...
--noinclude_scheduling_dependencies
--incompatible_allow_tags_propagation
--noincompatible_allow_tags_propagation
--incompatible_always_check_depset_elements
--noincompatible_always_check_depset_elements
...
--show_timestamps
--noshow_timestamps
--skyframe={off,summary,count,value,deps,rdeps}
--skyframe_high_water_mark_full_gc_drops_per_invocation=
--skyframe_high_water_mark_minor_gc_drops_per_invocation=
--skyframe_high_water_mark_threshold=
--skykey_filter=
